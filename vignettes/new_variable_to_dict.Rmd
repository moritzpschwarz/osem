---
title: "Adding a new variable to the Dictionary to use in the Aggregate Model"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Adding a new variable to the Dictionary to use in the Aggregate Model}
...
```{r, fig.height=5}
ggplot(dat_AT, aes(x = time, y = values, color = indic_bt)) + 
...
Let's visualise this model alongisde its forecast:

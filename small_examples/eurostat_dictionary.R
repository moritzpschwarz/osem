...
jonas_quarterly <- structure(list(model_varname = c("Supply", "Demand", "GDPOutput",
                                 "GDPExpenditure", "Taxes", "Subsidies", "VAAgriculture", "VAIndustry",
               ...
               full_name = c("Total Supply",
                             ...
                             "Product Taxes", "Product Subsidies", "Gross Value Added Agriculture",
               ...
               database = c(NA,
                            ...
                            "eurostat", "eurostat", "eurostat", "eurostat", "eurostat", "eurostat",
                            "eurostat", "eurostat", "eurostat", "eurostat", "eurostat", "eurostat",
                            "eurostat", "eurostat", "local", "local", "local"),
               variable_code = c(NA,
                                 NA, NA, NA, "D21REC", "D31PAY", "B1G", "B1G", "B1G", "B1G", "B1G",
               ...
               dataset_id = c(NA,
                              NA, NA, NA, "gov_10q_ggnfa", "gov_10q_ggnfa", "namq_10_a10",
                              ...
                              NA, NA),
               var_col = c(NA, NA, NA, NA, "na_item", "na_item", "na_item",
                           ...
                           "na_item"),
               freq = c(NA, NA, NA, NA, "Q", "Q", "Q", "Q", "Q",
                        "Q", "Q", "Q", "Q", "Q", "Q", "Q", "Q", "Q", "Q", "Q", "Q", "Q",
                        "Q", "Q", "Q", "Q", "Q", "Q", "Q", NA, NA, NA),
               geo = c(NA, NA,
                       NA, NA, "DE", "DE", "DE", "DE", "DE", "DE", "DE", "DE", "DE",
                       "DE", "DE", "DE", "DE", "DE", "DE", "DE", "DE", "DE", "DE", "DE",
                       "DE", "DE", "DE", "DE", "DE", NA, "DE", "DE"),
               unit = c(NA, NA,
                        NA, NA, "MIO_EUR", "MIO_EUR", "CP_MEUR", "CP_MEUR", "CP_MEUR",
               ...
               sector = c(NA, NA, NA, NA, "S13", "S13", NA, NA, NA, NA,
               ...
               tax = c(NA,
                       ...
                       NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                       NA),
               currency = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                            NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                            NA, NA, NA, NA, NA, NA, NA),
               direct = c(NA, NA, NA, NA, NA,
                          NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                          NA, "RECV", "PAID", "PAID", "PAID", "PAID", NA, NA, NA, NA,
                          NA, NA), co_nco = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                                              NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                                              NA, NA, NA, NA, NA, NA, NA),
               ...
               vehicle = c(NA,
                           NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                           NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                           NA), age = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                                        NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                                        NA, NA, NA, NA, NA, NA),
               partner = c(NA, NA, NA, NA, NA,
                           NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                           NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
               finpos = c(NA,
                          NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
                          NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "LIAB", NA, NA, NA,
                          NA, NA)), row.names = c(NA, -32L), class = c("tbl_df", "tbl",
                                                                       "data.frame"))
